 ...
 */
class Comment extends \Stel\Bundle\QuestionBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'thread', 'score', 'ancestors', 'parent', 'body', 'depth', 'createdAt', 'state', 'previousState');
        }
    ...
    public function incrementScore($by = 1)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'incrementScore', array($by));
