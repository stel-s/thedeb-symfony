 ...
 */
class ReasonAgainst extends \Stel\Bundle\QuestionBundle\Entity\ReasonAgainst implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'body', 'question');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReasonAgainst $proxy) {
